export interface MonsterDrop {
    itemId: string;
    chance: number; // % 단위 (1 = 1%, 0.1 = 0.1%, 100 = 100%)
}
...
export interface MonsterData {
    ...
    attack: number;
    isBoss: boolean;
    spawnChance: number; // % 단위 등장 확률 (25 = 25%, 5 = 5%)
    drops: MonsterDrop[];
}
        ...
        monsters: [
            {
                ...
                drops: [
                    { itemId: 'feed', chance: 10 },
                    { itemId: 'dubai_cookie', chance: 5 },
                    { itemId: 'ruby_necklace', chance: 2 },
                    { itemId: 'sapphire_ring', chance: 2 },
                ],
            },
            {
                name: '바위 골렘',
                ...
                drops: [
                    { itemId: 'feed', chance: 10 },
                    { itemId: 'dubai_cookie', chance: 5 },
                    { itemId: 'knight_helmet', chance: 2 },
                    { itemId: 'plate_armor', chance: 2 },
                ],
            },
            {
                name: '땅굴 거미',
                ...
                drops: [
                    { itemId: 'feed', chance: 10 },
                    { itemId: 'dubai_cookie', chance: 5 },
                    { itemId: 'steel_gauntlets', chance: 2 },
                    { itemId: 'mage_cloak', chance: 2 },
                ],
            },
            {
                name: '대지 도마뱀',
                ...
                drops: [
                    ...
                    { itemId: 'feed', chance: 10 },
                    { itemId: 'dubai_cookie', chance: 5 },
                    { itemId: 'wind_boots', chance: 2 },
                    { itemId: 'guardian_shield', chance: 2 },
                ],
            },
            {
                name: '거대 땅굴 벌레',
            ...
            },
            {
                ...
                drops: [
                    { itemId: 'dominator_stone', chance: 5 },
                    { itemId: 'weapon_enhance_scroll', chance: 50 },
                    { itemId: 'armor_enhance_scroll', chance: 50 },
                    { itemId: 'dubai_cookie', chance: 100 },
    ...
    },
    {
        ...
        monsters: [
            ...
            },
            {
                ...
                drops: [
                    { itemId: 'dominator_stone', chance: 70 },
        ...
        monsters: [
            ...
            },
            {
                ...
                drops: [
                    ...
                    { itemId: 'dragon_helmet', chance: 5 },
                    { itemId: 'dragon_armor', chance: 5 },
                ],
            },
        ],
    },
        ...
        monsters: [
            ...
            },
            {
                ...
                drops: [
                    ...
                    { itemId: 'accessory_enhance_scroll', chance: 100 },
                    { itemId: 'legend_meat', chance: 100 },
                    { itemId: 'aegis_shield', chance: 5 },
                    { itemId: 'titan_fists', chance: 5 },
                ],
            },
        ],
    },
